	...
	<div class="container mb-5 mt-5 pt-5 pb-5" style=" background-color: white;">
		...
		<div class="row row-content">
			<div class="col-12">
				...
				@if ($counter === 0)
				<button class="btn" style="background-color: #FCAB08; color: white;" onclick="dateCheck()">Apply Now</button>
				@else
				<button class="btn " style="background-color: #FCAB08; color: white;" onclick="dateCheck()" disabled>Applied</button>
				@endif
   ...
   <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
	...
	<script type="text/javascript">
		function dateCheck() {
			...
			var degreetype="{{$scholarship->degreetype}}";
			var prefDeg="{{$prefferedDegree}}";
			if(varDate >= today) {
				// 
				if (degreetype==prefDeg) {
			    	if(confirm("Once you applied, you can't cancel your Application. Are you sure to apply ?")){
			    ...
			    {
			    	alert("You are not eligible for this degree");
			    }
			}
			else{
