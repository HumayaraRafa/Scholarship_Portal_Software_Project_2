                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">New Scholarship Requests</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <form class="form-header" action="" method="POST">
                                                <input class="au-input au-input--xl" type="text" name="search" placeholder="Search by scholarship id" />
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>{{$data->headline}}</td>
                                                <td>
                                                    <span class="block-email">{{$data->postingdate}}</span>
                                                </td>
                                                <td class="desc">{{$data->degreetype}}</td>
                                                <td>{{$data->deadline}}</td>
                                                <td>{{$data->startingdate}}</td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="/admin/scholarship-requests/{{$data->scholarshipid}}/view">
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="View">
                                                                <i class="zmdi zmdi-edit"></i>
                                                            </button>
                                                        </a>&nbsp;&nbsp;
                                                        <a href="/admin/scholarship-requests/{{$data->scholarshipid}}/delete" onclick="return sureFunc();">
