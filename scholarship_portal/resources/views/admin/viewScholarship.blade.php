                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">{{$scholarship->headline}}</h2>
                        ...
                        <div class="row m-t-25">
                            <div class="col-md-12">
                                ...
                                <a href="/admin/scholarship-requests/{{$scholarship->scholarshipid}}/confirm"><button class="btn btn-success" >Confirm</button></a>
                                <a href="/admin/scholarship-requests/{{$scholarship->scholarshipid}}/recheck"><button class="btn btn-warning" >Recheck</button></a>
                                <a href="/admin/scholarship-requests/{{$scholarship->scholarshipid}}/reject"><button class="btn btn-danger" >Reject</button></a>
