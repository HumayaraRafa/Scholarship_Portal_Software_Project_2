...
<body class="animsition">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>{{$u}}</h2>
                                                <span>University Regsitered</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                                ...
                                <div class="overview-item overview-item--c3">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>{{$off}}</h2>
                                                <span>Scholarship offered this month</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                                ...
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>{{$app}}</h2>
                                                <span>Application this month</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">Pie Chart by offered degrees</h3>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card chart-percent-card">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 tm-b-5">Feedback by %<small style="font-size: 50%;">(Total feedback- {{$totalFeedback}})</small></h3> 
                                        <div class="row no-gutters">
                                            <div class="col-xl-6">
                                                <div class="chart-note-wrap">
                                                    <div class="chart-note mr-0 d-block">
                                                        <span class="dot dot--blue" style=""></span>
                                                        <span>Angry</span> (<small>{{$angryFeedback}} %</small>)
                                                    </div>
                                                    <div class="chart-note mr-0 d-block">
                                                        <span class="dot dot--red" style=""></span>
                                                        <span>Bad</span> (<small>{{$badFeedback}} %</small>)
                                                    </div>
                                                    <div class="chart-note mr-0 d-block">
                                                        <span class="dot" style="background-color: #C147DF;"></span>
                                                        <span>Average</span> (<small>{{$avgFeedback}} %</small>)
                                                    </div>
                                                    <div class="chart-note mr-0 d-block">
                                                        <span class="dot" style="background-color: #30B950;"></span>
                                                        <span>Good</span> (<small>{{$goodFeedback}} %</small>)
                                                    </div>
                                                    <div class="chart-note mr-0 d-block">
                                                        <span class="dot" style="background-color: #EE680F;"></span>
                                                        <span>Awesome</span> (<small>{{$awesomeFeedback}} %</small>)
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="percent-chart">
                                                    <canvas id="percent-charta"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Universities By most offerings</h2>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$data->countScholarship}}</td>
                                                <!-- <td><a href="/admin/uni/{{$data->universityname}}" class="btn btn-success">View</a></td> -->
                                            </tr>
                                            @endforeach
    ...
    <script type="text/javascript">
        (function ($) {
          ...
          try {
            var ctx = document.getElementById("percent-charta");
            if (ctx) {
              ctx.height = 280;
                  ...
                  datasets: [
                    {
                      ...
                      data: [{{$angryFeedback}}, {{$badFeedback}},{{$avgFeedback}},{{$goodFeedback}},{{$awesomeFeedback}}],
                      backgroundColor: [
                        '#00b5e9',
                        '#fa4251',
                        '#C147DF',
