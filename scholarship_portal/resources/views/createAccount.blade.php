			...
			<div class="col-12 col-sm-6 offset-sm-3 border-1 bg-light pt-3 pb-2">
				<form method="POST" name="infoForm" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" name="fullname" id="fullname" placeholder="Mr./Mrs. XYX" required>
				  </div>
				  <div class="form-row">
				  	<div class="form-group col-md-6">
					    <label for="qwert">User Name</label>
					    <input type="text" class="form-control" name="qwert" id="qwert" placeholder="Username" required>
					</div>
					<div class="form-group col-md-6">
					    <label for="country">Country</label>
					    <input type="text" class="form-control" name="country" id="userCountry" placeholder="Country Name" required>
					</div>
				  </div>
				  <div class="form-row">
				    <div class="form-group col-md-6">
				  ...
				  <div class="form-group">
				    <label for="prefferedDegree">Scholarship you are looking for</label>
				      <select id="prefferedDegree" name="prefferedDegree" class="form-control">
				  ...
				  <div class="form-group ">
			      	...
			      	<input type="file" class="form-control-sm" id="updateCv" name="StudentCV" accept="application/pdf" />
				  </div>
   ...
   <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
	...
	<script type="text/javascript">
		...
		my_form.onsubmit = function(){
		    ...
		    var filex=my_form.StudentCV.value.split('.').pop();
