...
<body>
	    ...
	    <ul class="navbar-nav ml-auto">
	      ...
	      <li class="nav-item dropdown active">
	        ...
	        <div class="dropdown-menu dropdown-menu-right dropdown-info" aria-labelledby="navbarDropdownMenuLink-4">
	          <a class="dropdown-item active" href="/university/profile">My Profile</a>
	...
	<div id="indexCar" class="carousel slide m-0 p-0 " data-bs-ride="carousel">
		  ...
		  <div class="carousel-caption">
		  	<h1 style="position: absolute;font-weight: 200%; left: 0%;top: -400%; right: 0%;bottom: 0%;color: #365783;" >{{$university->universityname}}</h1>
		  </div>
	</div>
