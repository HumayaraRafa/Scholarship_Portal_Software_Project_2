			...
			<div class="col-12">
				<form method="POST" id="newoffeform">
				  ...
				  <div class="form-group">
				    	...
				    	<input type="text" class="form-control" name="headline" id="headline" value="{{$scholarship->headline}}" required>
				  </div>
				  <div class="form-group">
				    <label for="degreetype">Select Degree</label>
				    <select class="form-control" id="degreetype" name="degreetype" required>
				    @if($scholarship->degreetype=="Bachelor")
				      <option value="Bachelor" selected>Bachelor</option>
				      <option value="Masters">Masters</option>
				      <option value="Ph.D">Ph.D</option>
				      <option value="Others">Others</option>
				    @elseif($scholarship->degreetype=="Masters")
				      <option value="Bachelor">Bachelor</option>
				      <option value="Masters" selected>Masters</option>
				      <option value="Ph.D">Ph.D</option>
				      <option value="Others">Others</option>
				    @elseif($scholarship->degreetype=="Ph.D")
				      <option value="Bachelor">Bachelor</option>
				      <option value="Masters" >Masters</option>
				  ...
				  <div class="form-group">
				    	...
				    	<textarea class="form-control" name="costing" id="costing"  rows="2" required>{{$scholarship->costing}}</textarea>
				  </div>
				  <div class="form-group">
				    	<label for="deadline">Last Date of Application</label>
					  	<input class="form-control" type="date" value="{{$scholarship->deadline}}" id="deadline" name="deadline" required>
				  </div>
				  <div class="form-group">
				    	<label for="startingdate">Class Start at</label>
					  	<input class="form-control" type="date" value="{{$scholarship->startingdate}}" id="startingdate" name="startingdate" required>
				  </div>
				  
				  
				  <div class="form-group">
				    	<label for="details">Scholarship Details</label>
				    	<textarea class="form-control" name="details" id="details" rows="6" required>{{$scholarship->details}}</textarea>
				  </div>
				  <div class="form-group">
				    	<label for="eligibility">Scholarship Eligibilty</label>
				    	<textarea class="form-control" name="eligibility" id="eligibility" rows="6" required >{{$scholarship->eligibility}}</textarea>
				  </div>
				  <div class="form-group">
				    	<label for="benefits">Scholarship Benefits</label>
				    	<textarea class="form-control" name="benefits" id="benefits" rows="6" required >{{$scholarship->benefits}}</textarea>
				  </div>
				  <div class="form-group">
				    	<label for="application">Scholarship Application</label>
				    	<textarea class="form-control" name="application" id="application" rows="6" required >{{$scholarship->application}}</textarea>
				  </div>
				  <div class="form-group">
				    	<label for="web">Scholarship Website link</label>
				    	<input type="text" class="form-control" name="web" id="web" value="{{$scholarship->web}}" required>
				  </div>
				  <br><hr><br>
				  <div class="col-12 text-center">
				  	<button class="btn btn-success" type="submit" onclick="checkfunction()">Update Scholarship</button>
				  </div>
				</form>
			</div>
		</div>
