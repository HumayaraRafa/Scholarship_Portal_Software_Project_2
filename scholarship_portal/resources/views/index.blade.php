	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	      <div class="modal-body text-center">
	        ...
	        <button class="btn btn-md border-0"  id="1Btn"> <a href="/feedback/Angry">
			...
			<button class="btn btn-md border-0" id="2Btn"> <a href="/feedback/Bad">
			...
			<button class="btn btn-md border-0" id="3Btn"> <a href="/feedback/Average">
				<svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-smile-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" id="4Btn"><a href="/feedback/Good">
				<svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-laughing-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" id="5Btn"><a href="/feedback/Awesome">
				<svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-heart-eyes-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
